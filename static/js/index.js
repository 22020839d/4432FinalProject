...
function renderEvents(events) {
    ...
    events.forEach(async obj => {
        ...
        const card = `
            <div class="col card m-2 justify-content-center" style="background: rgb(250,240,190)" id="${obj.eventname}">
                <a href="/booking.html?eventId=${obj.uid}">
                    <img class="card-img" src="${image}" style="width: 100%; height: 20rem; object-fit:cover">
                    <div class="card-body text-start">
                        <h5 class="card-title">Movie Name: ${obj.eventname}</h5>
                        <p class="badge p-2" style="background-color: rgb(192, 7, 192)">
                            ${obj.type}
                        </p>
