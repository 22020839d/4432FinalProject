  ...
  await fetch('/auth/api/events')  // Assuming this endpoint provides a list of events
    ...
    $(document).on('click', '#createEvent', function() {
        ...
        if(!eventname){
            ...
            alert("Moive picture cannot be empty");
        }
        else if (!eventSeatNumber){
            alert("Seat number cannot be empty");
        }
        else if (!eventDateTime){
            alert("Movie Date and Time cannot be empty");
        }
        else if (!eventVenue){
            alert("Movie Venue cannot be empty");
        }
                            ...
                            <div class="row">
                                <div class="container svg-seatmap col-6" style="text-align: center; max-width: 100%; display: flex; flex-direction: column; align-items: center;">
                                    ...
                                    <div class="d-flex d-inline justify-content-center">
                                        <p class="px-3 mx-5" style="background-color: #facde5;">Highest Price</p>
                                        <p class="px-3 mx-5" style="background-color: #f18dbc;">Middle Price</p>
                                        <p class="px-3 mx-5" style="background-color: #e0218a; color:white">Lowest Price</p>
                                        <p class="px-3 mx-5" style="color:#ffffff; background-color: #9b0101;">Not available</p>
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <form id="edit${event.title}" class="row" action="/auth/api/updateevent/${event.uid}" method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="mb-2">
                                                <label for="User_Image">Movie Picture</label>
...
async function editevent(eventid){
        ...
        if(!eventname){
            ...
            alert("Movie Picture cannot be empty");
        }
        else if(!eventPriceHigh || !eventPriceMiddle || !eventPriceLow){
            alert("Price cannot be empty");
        }
